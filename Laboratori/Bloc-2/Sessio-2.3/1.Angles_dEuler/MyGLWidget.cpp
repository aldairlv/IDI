...
//  glm::mat4 View = glm::lookAt(obs,vrp,up);
    ...
    View = glm::rotate(View,angle_phi,glm::vec3(0.0,0.0,1.0));
    View = glm::rotate(View,angle_theta,glm::vec3(1.0,0.0,0.0));
    View = glm::rotate(View,angle_psi,glm::vec3(0.0,1.0,0.0));
